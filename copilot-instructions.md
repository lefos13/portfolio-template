...
- When suggesting code, lean on Express 4 conventions, Sequelize for MySQL access, JWT authentication, Socket.IO messaging, and supporting services such as Firebase Cloud Messaging, Redis, and node-schedule.
